...
public class OverweightCategoryMaxTest {
    WebDriver driver;
    @Test
    public void overweightCategoryMinTest(){
        ...
        driver.findElement(By.xpath("//input[@name='wg']")).sendKeys("100.48");
        ...
        Assert.assertEquals(sIUnits, "30");
        Assert.assertEquals(uSUnits, "30.51");
        Assert.assertEquals(uKUnits, "190.5");
