...
public class OverweightCategoryMinTest {
    WebDriver driver;
    @Test
    public void overweightCategoryMinTest(){
        System.setProperty("webdriver.chrome.driver", "src/test/resources/chromedriver.exe");
        driver = new ChromeDriver();
        driver.get("https://healthunify.com/bmicalculator/");
        driver.findElement(By.xpath("//input[@name='wg']")).sendKeys("83.74");
        ...
        Assert.assertEquals(sIUnits, "25.01");
        Assert.assertEquals(uSUnits, "25.43");
        Assert.assertEquals(uKUnits, "158.81");
